        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <form
              ...
              className="bg-[var(--bg-card)] rounded-2xl border border-[var(--border-color)] p-6 lg:p-8 space-y-5 relative"
            >
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {info.map((item, index) => (
                <div
                  key={index}
                  className="p-5 bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] hover:border-primary-700 transition-colors"
                >
                  <div className="w-10 h-10 bg-primary-900/30 rounded-lg flex items-center justify-center mb-3">
                  ...
                  {item.href ? (
                    <a
                      href={item.href}
                      className="text-sm font-semibold text-[var(--text-primary)] hover:text-primary-600 transition-colors"
                    >
                      {item.value}
                    </a>
                  ) : (
