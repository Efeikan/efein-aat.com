      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <div className="bg-[var(--bg-card)] rounded-2xl border border-[var(--border-color)] p-8 lg:p-12 relative overflow-hidden">
            <Quote className="absolute top-6 right-6 w-16 h-16 text-primary-900/30" />
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button
              onClick={prev}
              className="p-2 rounded-full bg-[var(--bg-secondary)] text-[var(--text-secondary)] hover:text-primary-600 hover:bg-primary-900/20 transition-colors"
              aria-label="Previous"
            >
