          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="group p-6 lg:p-8 bg-[var(--bg-card)] rounded-2xl border border-[var(--border-color)] hover:border-primary-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
                <div className="w-14 h-14 bg-primary-900/30 rounded-xl flex items-center justify-center mb-5 group-hover:bg-primary-600 group-hover:scale-110 transition-all duration-300">
