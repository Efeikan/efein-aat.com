          ...
          {items.map((item, index) => (
            ...
            >
              <button
                ...
                className="w-full text-left p-5 lg:p-6 bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] hover:border-primary-700 transition-all duration-200 group"
              >
